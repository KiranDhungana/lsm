...
class CourseApiController extends Controller
{
    ...
    {
        $courses = Course::where('type', '1')->latest('total_enrolled')->take(10)->get();
    ...
    {
        $courses = Course::where('type', '2')->latest('total_enrolled')->take(10)->get();
    ...
    {
        $courses = Course::where('type', '3')->latest('total_enrolled')->take(10)->get();
