                        ...
                        <ul class="d-flex gap-3 flex-wrap align-items-center meta">
                            ...
                            <li class="meta_item">
                                <div class="rating d-flex gap-1">
                                    ...
                                    @endphp
                                    @for ($i = 0; $i <  $stars; $i++)
                                        <img src="{{asset('public/frontend/infixlmstheme/img/svg/full_star.svg')}}"
                                             alt="">
                                    @endfor
                                    @if ($main_stars>$stars)
                                                                                ...
                                                                                @auth()
                                                                                    @if(!$r->isLoginUserEnrolled && !$r->isLoginUserCart)
                                                                                        <a href="#" class="cart_store"
                                                                                           data-id="{{$r->id}}">
                                                                                            <img
                                                                                                src="{{asset('public/frontend/infixlmstheme/svg/cart.svg')}}"
                                                                                                alt="cart">
                                                                                        </a>
                                                                                    @endif
                                                                                @endauth
                        ...
                        <div class="course_sidebar">
                            ...
                            <div class="sidebar__widget">
                                ...
                                <ul class="course_includes">
                                    <li>
                                        <img src="{{asset('public/frontend/infixlmstheme/svg/clock.svg')}}" alt="">
                                        <p class="nowrap"> {{ __('frontend.Duration') }} {{MinuteFormat($course->duration)}}

                                        </p>
                                    </li>
                                    <li>
                                        <img src="{{asset('public/frontend/infixlmstheme/svg/open-book.svg')}}" alt="">
                                    ...
                                    @endif
                                    <li>
                                        <img src="{{asset('public/frontend/infixlmstheme/svg/tag.svg')}}" alt="">
                                    ...
                                    <li>
                                        <img src="{{asset('public/frontend/infixlmstheme/svg/globe.svg')}}" alt="">
                                    ...
                                    @if(isModuleActive('SupportTicket') && $course->support)
                                        <li>
                                            <img src="{{asset('public/frontend/infixlmstheme/svg/question.svg')}}"
                                                 alt="">
