                            ...
                            <div class="white-box  student-details header-menu">
                                ...
                                <div class="add-visitor">
                                        ...
                                        @foreach ($LanguageList as $key => $language)
                                            <div role="tabpanel"
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="input-effect">
                                                            <label class="primary_input_label mt-1"> {{ __('quiz.Quiz Title') }} <span
                                                ...
                                                <div class="row mt-25">
                                                    <div class="col-lg-12">
                                                        <div class="input-effect">
                                                            <label class="primary_input_label mt-1">{{ __('quiz.Instruction') }} <span
                                                                    class="required_mark">*</span></label>
                                                            <textarea
                                    ...
                                    <div class="row mt-25">
                                        <div class="col-lg-12">
                                            <div class="input-effect">
                                                <label class="primary_input_label mt-1">{{ __('quiz.Minimum Percentage') }} <span
                                                        class="required_mark">*</span></label>
                                    ...
                                    @if (!isset($online_exam))
                                        <div class="row mt-25">
                                            <div class="col-lg-12">
                                                <label class="primary_input_label mt-1">{{ __('quiz.Set Random Question') }} <span class="required_mark">*</span></label>
                                            </div>
                                            <div class="col-lg-12 ">
                                            ...
                                            <div class="col-md-12   set_random_question_box d-none">
                                                <div class="input-effect">
                                                    <label class="primary_input_label mt-1"> {{ __('quiz.Number Of Question') }}
                                    ...
                                    <div class="row mt-25">
                                        <div class="col-lg-12">
                                            <label class="primary_input_label mt-1">{{ __('quiz.Change Default Settings') }}</label>
                                        </div>
                                        <div class="col-lg-12 ">
                                    ...
                                    <div class="row mb-25 mt-25 default-settings gap-4"
                                        ...
                                        <div class="col-lg-12 mb-25">
                                            <div class="input-effect">
                                                <label class="primary_input_label mt-1">{{ __('quiz.Time') }} ({{ __('quiz.In Min') }})
